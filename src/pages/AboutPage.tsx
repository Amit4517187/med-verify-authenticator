    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-16 md:py-24 bg-medical-pattern">
        ...
        <div className="container relative mx-auto px-4 text-center">
          <ScrollReveal>
            <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/10 px-4 py-1.5 text-sm font-bold text-primary">
              <Shield className="h-4 w-4" />
              {t("ourStory")}
            </div>
            <h1 className="mt-6 font-display text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl md:text-6xl">
              {t("aboutTitle")}
            </h1>
      ...
      <section className="py-14 md:py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto mt-12 grid max-w-4xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {builtBy.map((item, idx) => (
              <ScrollReveal key={item.label} delay={idx * 0.1}>
                <div
                  className="rounded-xl border border-border/60 bg-white p-5 text-center shadow-sm hover:border-primary/30 hover:shadow-md transition-all h-full"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-4">
              {techSteps.map((item, idx) => (
                <ScrollReveal key={item.num} delay={idx * 0.1} direction="right">
                  <div className="flex gap-4 rounded-xl border border-border/60 bg-background p-4 sm:p-5">
      ...
      <section className="py-14 md:py-20 bg-muted/40">
        <div className="container mx-auto px-4 text-center">
          <ScrollReveal>
            ...
            <p className="mx-auto mt-3 max-md text-sm text-muted-foreground sm:text-base">
              {t("collaborateDesc")}
            </p>
