...
const ResultsPage = () => {
  ...
  const configMap: Record<string, {
    ...
    verified_database: {
      Icon: ShieldCheck,
      title: t("verifiedDbTitle") || "Database Verified",
      desc: t("verifiedDbDesc") || "This medicine is found in the authorized national registry.",
      bgClass: "bg-primary/8",
      textClass: "text-primary",
      borderClass: "border-primary/30",
      badgeBg: "bg-primary/10",
      safetyEmoji: "✅",
      safetyLabel: t("verifiedDbSafetyLabel") || "Official Match",
      actionMessage: t("verifiedDbAction") || "Authorized Registry",
    },
    verified_barcode: {
      Icon: ShieldCheck,
      title: t("verifiedBarcodeTitle") || "Barcode Verified",
      desc: t("verifiedBarcodeDesc") || "The barcode matches an entry in the global pharmacy database.",
      bgClass: "bg-primary/8",
      textClass: "text-primary",
      borderClass: "border-primary/30",
      badgeBg: "bg-primary/10",
      safetyEmoji: "✅",
      safetyLabel: t("verifiedBarcodeSafetyLabel") || "Valid ID",
      actionMessage: t("verifiedBarcodeAction") || "Barcode Match",
    },
    verified_global: {
      Icon: ShieldCheck,
      title: t("verifiedGlobalTitle") || "Globally Recognized",
      desc: t("verifiedGlobalDesc") || "This medicine's active ingredients are recognized in global registries.",
      bgClass: "bg-blue-500/8",
      textClass: "text-blue-600",
      borderClass: "border-blue-500/30",
      badgeBg: "bg-blue-500/10",
      safetyEmoji: "✅",
      safetyLabel: t("verifiedGlobalSafetyLabel") || "Global Match",
      actionMessage: t("verifiedGlobalAction") || "NIH RxNorm Verified",
    },
    caution: {
      Icon: ShieldAlert,
      title: t("cautionTitle") || "Quality Warning",
      desc: t("cautionDesc") || "This medicine has a recent laboratory failure alert.",
      bgClass: "bg-warning/8",
      textClass: "text-warning",
      borderClass: "border-warning/30",
      badgeBg: "bg-warning/10",
      safetyEmoji: "⚠️",
      safetyLabel: t("cautionSafetyLabel") || "Warning",
      actionMessage: t("cautionAction") || "Check Batch",
    },
    danger: {
      Icon: ShieldX,
      title: t("dangerTitle") || "Regulatory Alert",
      desc: t("dangerDesc") || "This formulation matches a substance flagged by regulatory authorities.",
      bgClass: "bg-destructive/8",
      textClass: "text-destructive",
      borderClass: "border-destructive/30",
      badgeBg: "bg-destructive/10",
      safetyEmoji: "🚫",
      safetyLabel: t("dangerSafetyLabel") || "Prohibited",
      actionMessage: t("dangerAction") || "Do Not Use",
    },
    unable_to_verify: {
      Icon: HelpCircle,
      title: t("unableTitle") || "Unknown Status",
      desc: t("unableDesc") || "This medicine could not be matched against our current registries.",
      bgClass: "bg-slate-500/8",
      textClass: "text-slate-600",
      borderClass: "border-slate-500/30",
      badgeBg: "bg-slate-500/10",
      safetyEmoji: "🔍",
      safetyLabel: t("unableSafetyLabel") || "Inconclusive",
      actionMessage: t("unableAction") || "Verify Manually",
    },
  };
